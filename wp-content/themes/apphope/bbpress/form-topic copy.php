			...
			<fieldset class="bbp-form">
				...
				<div>
					...
					<?php if ( current_user_can( 'moderate' ) ) : ?>
						...
						<p><label for="bbp_stick_topic"><?php _e( 'Topic Type:', 'bbpress' ); ?></label><?php bbp_form_topic_type_dropdown(); ?>	</p>
						<?php do_action( 'bbp_theme_after_topic_form_type' ); ?>
						<?php do_action( 'bbp_theme_before_topic_form_status' ); ?>
						<p><label for="bbp_topic_status"><?php _e( 'Topic Status:', 'bbpress' ); ?></label><?php bbp_form_topic_status_dropdown(); ?></p>

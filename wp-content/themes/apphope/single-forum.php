...
<div class="dr_reply_single_form_background">
</div>
<div class="top_banner"><div class="shadow"></div>
	<div class="container">
		<div class="row">
			<div class="col-lg-10 title-column">
				<a href="/forums" class="back-forum"><i class="fa fa-angle-left"></i> &nbsp; Forum</a>
				<h1><?=bbp_forum_title();?></h1>
			</div>
...
<div class="dream-links forum-links">
	<div class="container">
		<div class="row">
			<div class="col first">
				<div class="col-inner bordered dr_reply_single_form_btn"><a class="btn btn-blue forum-fancy" href="#">Add New Topic</a></div>
			</div>
			<div class="col">
				<div class="col-inner">
			...
			<div class="col last">
				<div class="col-inner" rel="<?php $forum_id = bbp_forum_id();?>"><?=bbp_get_forum_topic_count($forum_id);?> Topics</div>
			</div>
		</div>
	</div>
</div>
<div class="wide_content gray"><div class="shadow"></div>
	<div class="container">
            <?php if ( !bbp_is_single_forum() ) : ?><div id="bbpress-forums"><?php bbp_breadcrumb(); ?><?php endif; ?>

                <div class="dr_reply_single_form">
                        ...
                        <div id="new-topic-<?php bbp_topic_id(); ?>" class="bbp-topic-form">
                            <form id="new-post" name="new-post" method="post" action="<?php the_permalink(); ?>">
                                ...
                                <fieldset class="bbp-form">
                                    ...
                                    <div class="row mt-14"><?php global $current_user;?>
                                        <?php $umeta = get_user_meta( $current_user->ID);?>
                                        <div class="col-lg-2"><div class="avatar" ><?=get_avatar( $current_user->ID, 70 ); ?><div class="name"><?=$umeta['first_name'][0].' '.$umeta['last_name'][0];?></div></div></div>
                                        <div class="col-lg-10">
                                            <?php bbp_get_template_part( 'form', 'anonymous' ); ?>
                                            <?php do_action( 'bbp_theme_before_topic_form_title' ); ?>
                                            <p>
                                                <label for="bbp_topic_title"><?php printf( __( 'Subject (Maximum Length: %d):', 'bbpress' ), bbp_get_title_max_length() ); ?></label><br />
                                            ...
                                            <?php if ( current_user_can( 'moderate' ) ) : ?>
                                                ...
                                                <p class="popts"><label for="bbp_stick_topic"><?php _e( 'Topic Type:', 'bbpress' ); ?></label><?php bbp_form_topic_type_dropdown(); ?>	</p>
                                                <?php do_action( 'bbp_theme_after_topic_form_type' ); ?>
                                                <?php do_action( 'bbp_theme_before_topic_form_status' ); ?>
                                                <p class="popts"><label for="bbp_topic_status"><?php _e( 'Topic Status:', 'bbpress' ); ?></label><?php bbp_form_topic_status_dropdown(); ?></p>
                                            ...
                                            <div class="bbp-submit-wrapper">
                                                ...
                                                <?php /*<button type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_topic_submit" name="bbp_topic_submit" class="button submit"><?php _e( 'Submit', 'bbpress' ); ?></button>*/?>
                                                <input class="btn-blue btn submit" type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_topic_submit" name="bbp_topic_submit" value="<?php _e( 'Submit', 'bbpress' ); ?>" />
                ...
                <?php if ( !bbp_is_single_forum() ) : ?></div><?php endif; ?>
		...
		<?php do_action( 'bbp_template_notices' ); ?>
			...
			<?php if ( bbp_user_can_view_forum() ) : ?>
				<div id="forum-<?php bbp_forum_id(); ?>" class="bbp-forum-content">
					<div class="entry-content"><?php bbp_get_template_part( 'content', 'single-forum' ); ?></div>

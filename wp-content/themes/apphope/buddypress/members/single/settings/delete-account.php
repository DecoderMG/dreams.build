...
<form action="<?=bp_displayed_user_domain().bp_get_settings_slug().'/delete-account'; ?>" name="account-delete-form" id="account-delete-form" class="standard-form" method="post">
	<?php /* Fires before the display of the submit button for user delete account submitting.
	 * @since 1.5.0*/

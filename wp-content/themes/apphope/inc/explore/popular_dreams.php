<script>
	...
	var pieces = Math.floor(width/(slideWidth+30));
        var options = {
			...
			$Cols: pieces, //Number of pieces to display (the slideshow would be disabled if the value is set to greater than 1), the default value is 1
  ...
  jssor_slider2.$On($JssorSlider$.$EVT_PARK,  function(slideIndex){
    ...
    <div id="popular-slides" class="slider2_container" style="height: 532px;">
         <!-- Loading Screen -->
        ...
        <div u="slides" class="slides">
	        <?php query_posts( array( 'post_type' => 'ignition_product','post_status'=>'publish', 'meta_key' => 'ign_sponsor_count', 'orderby' => 'meta_value_num', 'order' => 'DESC','posts_per_page' => 8 ) );

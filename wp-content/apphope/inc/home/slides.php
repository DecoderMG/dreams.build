...
jQuery(document).ready(function ($) {
    ...
    <div id="slider1_container" style="height: 400px;">
        ...
        <?php $args = array('post_type'=>'slides', 'post_status'=>'publish', 'posts_per_page' => -1, 'tax_query' => array('relation' => 'AND', array('taxonomy' => 'slides_category','field' => 'slug', 'terms' => 'home'))); $the_query = new WP_Query( $args );?>

<script>
    	...
    	var pieces = Math.floor(width/(slideWidth+30));
            ...
            var jssor_slider2 = new $JssorSlider$("near-slides", options);
            ...
            jssor_slider2.$On($JssorSlider$.$EVT_PARK,  function(slideIndex)
			{
			   ...
			   jQuery('#near-slides .slide').fadeTo(1,1);
               jQuery('#near-slides .slide:eq('+left_slide+'), #near-slides .slide:eq('+right_slide+')').fadeTo('fast',0.4);
			});
    ...
    <div id="near-slides" class="slider2_container" style="height: 532px;">
         <!-- Loading Screen -->
        ...
        <div u="slides" class="slides">
	        <?php query_posts( array( 'post_type' => 'ignition_product','post_status'=>'publish', 'project_category' => 'Trending','posts_per_page' => 8  ) );
				if ( have_posts() ) : $i=0;while ( have_posts() ) : the_post();$i++;?>
						...
						<div class="slide num<?=$i?>">
			            	...
			            	<img class="image" u="image" src="<?=$image[0]?>">
			            	<div class="box">

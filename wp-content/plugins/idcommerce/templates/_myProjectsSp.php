<div class="gridbox-post" id="post-<?=$post_id?>">
	<div class="gridbox">
		...
		<div class="box">
			...
			<div class="avatar"><a href="<?=$aurl?>"><?=get_avatar(get_the_author_meta('ID'),68); ?></a><div class="name"><a href="<?=$aurl?>"><?=(empty($user_firstname))?get_the_author():$user_firstname.' '.$user_lastname;?></a></div></div>

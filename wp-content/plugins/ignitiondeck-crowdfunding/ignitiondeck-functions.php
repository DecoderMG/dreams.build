...
//        } else if ($old_status == 'publish' && $new_status == 'closed')  {
//            // Seems it should be processed outside this cases as part of cron automation
//            $action = 'project_closed';
//            $subject = 'Your project ended';
//        } else if ($old_status == 'draft' && $new_status == 'closed')  {
//            $action = 'project_rejected';
//            $subject = 'Your project rejected';
//        } else {
//            //..
//        }
//        if (isset($action)) {
...
function schedule_hourly_id_cron() {
	...
	$percent = ID_Project::set_percent_meta();
	$status = ID_Project::set_status_for_all_project();

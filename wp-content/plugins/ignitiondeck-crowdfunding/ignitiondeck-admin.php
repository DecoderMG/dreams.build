...
function ign_project_status_update( $new_status, $old_status, $post )
{
...
//		} else if ($old_status == 'publish' && $new_status == 'pending')  {
//			// Seems it should be processed outside this cases as part of cron automation
//			$action = 'project_new';
//			$subject = 'Your project ended';
		} else if ($old_status == 'draft' && $new_status == 'pending')  {
			// Seems it should be processed outside this cases as part of cron automation
			$action = 'project_new';
			$subject = 'Your dream is under review';
		} else if ($old_status == 'pending' && $new_status == 'closed')  {
			$action = 'project_rejected';
			$subject = 'Shucks dream has been rejected';
...
add_action( 'transition_post_status', 'ign_project_status_update', 10, 3 );

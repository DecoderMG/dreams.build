...
function fep_message_box($action = '', $title = '', $total_message = false, $messages = false )
{
	global $user_ID;
      ...
      if ($total_message)
      {
			...
			$msgsOut .= "<p class='dr_messbox_title'><strong>$title</strong></p>";
		...
		foreach($messages as $msg){
			...
			$delete = "<a href='".apply_filters('fep_delete_message_url', $del_url, $pID) ."' onclick='return confirm(\"".__('Are you sure?', 'fep')."\");'><div class='dr_msg_circle user_avatar' style='margin-left: 18.5px !important; position: absolute;margin-top: 6.4px;'></div></a>";
				$msgsOut .= "
					<div class='row' style='margin-bottom: 10px;'>
						
						<div class='col-md-12'>
						
							<div class='row umbra' style='border-bottom: #54bbd5; border-bottom-style: solid;border-bottom-width: 1px'>
						
								<div class='col-md-1 col-xs-2 col-sm-1' style='padding: 0; margin-left: -15px'>
									        <a class=\"user_avatar  fancy\" rel=\"1\" href=\"#profile-box\" style=\" position: absolute;  margin-left: 23px;margin-top: 3px;\">".get_avatar($msg->from_user,'id')."</a>".$delete."
								</div>
								<a class='dr_msg_subject' href='".fep_action_url()."viewmessage&id=".$msg->id."'>
								<div class='col-md-7 col-xs-6 col-sm-7' style='margin-top: 6px; '>
									<div class='row'>
										<div class='col-md-12'>
										   <span class='dr_msg_sender' >" .fep_get_userdata( $msg->from_user, 'display_name', 'id' ). "</span>
										</div>
										<div class='col-md-12'>
											<span class='dr_msg_subject' >".fep_output_filter($msg->message_title,true)."</span>
										</div>
										<div class='col-md-12'>
											".fep_format_date($msg->last_date)."
										</div>
									</div>
								</div>
								
								<div class='col-md-4 col-xs-4 col-sm-4 dr_msg_send_date' style=''  >".date(  "l F j, Y h:i a", strtotime( $msg->send_date ) )."</div></a>
							</div>
						</div>
					</div>";
